...
const parkCardThree = new questionCard (
...
const parkCardFour = new questionCard (
...
const parkCardFive = new questionCard(
...
const parkCardSix = new questionCard (
...
const parkCardSeven = new questionCard (
...
const parkCardEight = new questionCard (
...
const parkCardNine = new questionCard (
...
const parkCardTen = new questionCard (
...
function displayQuestionCard() {
        ...
        const card = questionCard[activeCard]
